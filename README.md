...
- [Go Web-Beispiele](https://github.com/gowebexamples/gowebexamples) - Go Web-Entwicklungsbeispiele
...
- [go-getter](https://github.com/hashicorp/go-getter) - kann Dateien oder Verzeichnisse aus verschiedenen Quellen herunterladen, wobei die URL als Haupteingabeform verwendet wird
...
- [woke](https://github.com/get-woke/woke) - Textdateien auf diskriminierende Wörter prüfen
...
- [Ginster](https://github.com/zhenghaoz/gorse) - Ein-Knoten-Training und verteilte prädiktive Empfehlungssystem-Engine
...
- [bimg](https://github.com/h2non/bimg) - Bildverarbeitung
...
#### Statische Ressourceneinbettung
...
- [gofight](https://github.com/appleboy/gofight) - Testen des API-Handlers
...
- [go-set](https://github.com/scylladb/go-set) - Sammlungs-Toolkit
- [orderedmap](https://github.com/elliotchance/orderedmap) - geordnetes Wörterbuch
- [versuchen](https://github.com/dghubble/trie)
- [Slim](https://github.com/openacid/slim) - Datenstruktur mit hoher Platznutzung
- [bitset](https://github.com/bits-and-blooms/bitset) - Bitsets und ihre Operationen
- [roaring](https://github.com/RoaringBitmap/roaring) - komprimierte Bitmap


### Abhängigkeitsspritze
- [go-autowire](https://github.com/Just-maple/go-autowire) - Automatische Generierung mit Anmerkungen [wire](https://github.com/google/wire) - Dependency Injection
- [graben](https://github.com/uber-go/dig)
- [FX](https://github.com/uber-go/fx)


###JSON
- [GJSON](https://github.com/tidwall/gjson) - JSON-Interpreter
- [SJSON](https://github.com/tidwall/sjson) - JSON-Modifikationstool
- [fastjson](https://github.com/valyala/fastjson) - schneller JSON-Parser und Validator für Go
- [jsonparser](https://github.com/buger/jsonparser)
- [ffjson](https://github.com/pquerna/ffjson)
- [json-iterator](https://github.com/json-iterator/go) - Didi-Open-Source-JSON-Parser
- [gojsonq](https://github.com/thedevsaddam/gojsonq) - JSON/YAML/XML/CSV und andere Datenabfragen
- [easyjson](https://github.com/mailru/easyjson)
- [go-jsonc](https://github.com/akshaybharambe14/go-jsonc) - Wandelt annotiertes JSON in unkommentiert um
- [jin](https://github.com/ecoshub/jin) - JSON-Manipulations-Toolkit mit Standardbibliothek und Funktionen wie "tidwall/gjson" und "tidwall/sjson".
- [hujson](https://github.com/tailscale/hujson) - unterstützt JSON-Decodierung für Anmerkungen
- [pkg/json](https://github.com/pkg/json) - JSON-Decoder
- [ColorJSON](https://github.com/TylerBrock/colorjson) - Farb-JSON im Terminal drucken
- [jid](https://github.com/simeji/jid) - Tool zum Analysieren und Lesen von JSON-Daten
- [jsonc](https://github.com/tidwall/jsonc) - unterstützt Kommentare und Kommas
- [sonic](https://github.com/bytedance/sonic) - Bytedance Open-Source-JSON-Parser und -Modifikator
- [go-json](https://github.com/goccy/go-json)
- [jsonquery](https://github.com/antchfx/jsonquery) - XPath-Syntaxabfrage JSON
- [fx](https://github.com/antonmedv/fx) - Befehlszeilen-JSON-Anzeige


### Abhängigkeitsverwaltung
- [**goproxy.io**](https://github.com/goproxyio/goproxy) - `GOPROXY`-Proxy-Dienst
- [goproxy.cn](https://github.com/goproxy/goproxy.cn) - Proxy-Dienst, der eher für Privatanwender geeignet ist
- [Gopm](https://github.com/gpmgo/gopm) - Go-Paketverwaltungstool
- [govendor](https://github.com/kardianos/govendor) - Paketverwaltungstool für Anbieter
- [gom](https://github.com/mattn/gom) - Verwaltungstool für Paketversionen
- [rvflash/goup](https://github.com/rvflash/goup) - Prüfen Sie, ob die Paketversion aktualisiert ist
- [owentheal/goup](https://github.com/owentheal/goup) - Wechseln Sie zur Verwaltung mehrerer Versionen
- [Athen](https://github.com/gomods/athens) - „GOPROXY“-Proxy-Dienst


### Mikrodienste
- [Istio](https://github.com/istio/istio) [[Chinesische Dokumentation](https://preliminary.istio.io/zh/docs/)] – ein großes Microservice-Systemverwaltungstool
...
- [GoKit CLI](https://github.com/kujtimiihoxha/kit) - Go-Kit-Gerüst
- [gogo](https://github.com/dolab/gogo)
- [go-chassis](https://github.com/go-chassis/go-chassis)
- [Drachen](https://github.com/koding/kite)
- [Kratos](https://github.com/bilibili/kratos) - B-Station-Open-Source-Microservice-Framework
- [Temporal](https://github.com/temporalio/temporal) - Microservice-Orchestrierungsplattform
- [Serf](https://github.com/hashicorp/serf) - Service-Orchestrierungs-Verwaltungsplattform
- [Open Policy Agent](https://github.com/open-policy-agent/opa) - allgemeine Richtlinien-Engine, CNCF-Inkubationsprojekt
- [gizmo](https://github.com/nytimes/gizmo) - Microservice-Toolset
- [MOSN](https://github.com/mosn/mosn) - Cloud-native Netzwerkdatenebene für Edge- und Service-Mesh
- [Erda](https://github.com/erda-project/erda) – PaaS, das DevOps, Microservice-Governance und Multi-Cloud-Management für Unternehmen bereitstellt


### Serverlos
- [OpenFaaS](https://github.com/openfaas/faas) - Serverlose Funktionen leicht gemacht (FaaS-Framework für Funktionsdienste)
- [faasd](https://github.com/openfaas/faasd) - Leichte FaaS-Engine
- [fn](https://github.com/fnproject/fn) - Ereignisgesteuertes FaaS
- [riff](https://github.com/projectriff/riff) - Kubernetes-basiertes FaaS
- [Nuclio](https://github.com/nuclio/nuclio) - Serverloses Framework für Echtzeitereignisse und -daten
- [Flogo](https://github.com/tibcosoftware/flogo) - Ereignisgesteuertes serverloses Framework
- [Dapr](https://github.com/dapr/dapr) - Microsofts Open-Source-Microservice-Komponenten für Cloud- und Edge-Computing
- [kubeless](https://github.com/kubeless/kubeless)
- [Fission](https://github.com/fission/fission) - Serverlos auf Kubernetes
...
- [scholz/faas](https://github.com/schollz/faas) - Machen Sie die Funktion eines beliebigen Pakets zu einer HTTP-Schnittstelle


### Entwickler
- [act](https://github.com/nektos/act) - lokal ausführen [GitHub Actions](https://developer.github.com/actions/)


### Kontinuierliche Integration/Bereitstellung
- [CDS](https://github.com/ovh/cds) - Kontinuierlicher Integrationsdienst
- [gopub](https://github.com/linclin/gopub)
- [CodePub](https://github.com/bzppx/bzppx-codepub)
- [syncd](https://github.com/dreamans/syncd) - Codebereitstellungstool
- [Drone](https://github.com/drone/drone) - Docker-basierte Continuous-Release-Plattform
- [Cyclone](https://github.com/caicloud/cyclone) - kontinuierliche Integrations- und Release-Plattform
- [tbls](https://github.com/k1LoW/tbls) - CI-freundliches Tool zur Dokumentation von Datenbanken
- [Woodpecker](https://github.com/woodpecker-ci/woodpecker) - Fork von Drone


### Git
- [gogs](https://github.com/gogs/gogs) - Git-Server ähnlich GitLab
- [Gitea](https://github.com/go-gitea/gitea) - Git-Server von gogs gegabelt
- [go-git](https://github.com/go-git/go-git) - In Go implementierte Git-Operationen
- [gitin](https://github.com/isacikgoz/gitin) - Commit/Branch/Status-Explorer für Git
- [hub](https://github.com/github/hub) - GitHub-Befehlszeilentool
- [git-o-matic](https://github.com/muesli/gitomatic) - ein Tool zur Überwachung von Git-Warehouse-Änderungen und automatischem Pull/Push
- [gitbase](https://github.com/src-d/gitbase) - Abfrage von Git-Protokollen in SQL
- [git-chglog](https://github.com/git-chglog/git-chglog) - Verwaltungstool "CHANGELOG".
- [chglog](https://github.com/goreleaser/chglog) - Verwaltungstool "CHANGELOG".
- [lazyhub](https://github.com/ryo-ma/lazyhub) - Terminal-UI-Client für GitHub
- [goaction](https://github.com/posener/goaction) - Schreiben von GitHub-Aktionen in Go
- [bit](https://github.com/chriswalz/bit) - Git-Befehlserweiterungen mit Unterstützung für die automatische Vervollständigung von Datei- und Zweignamen, Befehls- und Flag-Vorschlägen
- [go-github](https://github.com/google/go-github) - GitHub-API-Operationsbibliothek
- [askgit](https://github.com/augmentable-dev/askgit) - Zugriff auf Git-Repository-Informationen über SQL
- [git2graph](https://github.com/alaingilbert/git2graph) - Generieren Sie ein Strukturdiagramm basierend auf dem Commit-Datensatz des Git-Warehouse
- [lazygit](https://github.com/jesseduffield/lazygit) - Git-Terminal-UI
- [gh-dash](https://github.com/dlvhdr/gh-dash) - GitHub CLI (`gh`) schönes Terminal-Panel


### Strombegrenzer
- [**Tollbooth**](https://github.com/didip/tollbooth) - Einfache Middleware zur Ratenbegrenzung von HTTP-Anfragen
- [Ratenlimit](https://github.com/juju/ratelimit)
- [RateLimit](https://github.com/bsm/ratelimit)
- [go-rate](https://github.com/beefsack/go-rate)
- [Circuit](https://github.com/cep21/circuit) - Leistungsschalter
- [uber-go/ratelimit](https://github.com/uber-go/ratelimit)
- [Sentinel](https://github.com/sentinel-group/sentinel-golang) - Alibabas Open-Source-Distributed-Service-Architektur-orientierte Ablaufsteuerungskomponente Go-Sprachversion
- [gohalt](https://github.com/1pkg/gohalt) - Strombegrenzung
- [gobreaker](https://github.com/sony/gobreaker) - Unterbrecher
- [ulule/limiter](https://github.com/ulule/limiter)


### Übersetzer
- [TinyGo](https://github.com/tinygo-org/tinygo) - Ein Go-Compiler für Mikrocontroller, WebAssembly und Befehlszeilen-Tools
- [minigo](https://github.com/DQNEO/minigo) - Ein Go-Compiler von Grund auf neu
- [llir/llvm](https://github.com/llir/llvm) - LLVM-Compiler
- [jit-compiler](https://github.com/bspaans/jit-compiler) - `JIT`-Compiler
- [Go+](https://github.com/goplus/gop) - Qiniu Cloud Open Source Data Science-orientierte Sprache, vollständig kompatibel mit der Go-Sprache


### Dolmetscher
#### Sprachdolmetscher
- [**participle**](https://github.com/alecthomas/participle) - Allgemeines benutzerdefiniertes Grammatik-Parsing-Paket
- [GopherLua](https://github.com/yuin/gopher-lua) - VM und Compiler für Lua in Go
- [go-lua](https://github.com/Shopify/go-lua) - Eine Lua-VM in reinem Go
- [DCLua](https://github.com/milochristiansen/lua) - Go Lua Compiler und VM
- [otto](https://github.com/robertkrimen/otto) - JavaScript-Interpreter
- [goja](https://github.com/dop251/goja) - ECMAScript 5.1(+)-Implementierung
- [v8go](https://github.com/rogchap/v8go) - Führen Sie JavaScript von Go aus
- [gpython](https://github.com/go-python/gpython) - Python-Interpreter für Go
- [Grumpy](https://github.com/google/grumpy) - Konvertieren Sie Python in Go-Code, Open Source von Google
...
- [GopherJS](https://github.com/gopherjs/gopherjs) - Go-Code in JavaScript-Code kompilieren
- [Yaegi](https://github.com/containous/yaegi) - Go-Sprachdolmetscher
- [Eigenschaften](https://github.com/magiconair/properties) - Java-Eigenschaften-Scanner für Go
- [jvm.go](https://github.com/zxh0/jvm.go) - JVM
- [gobasic](https://github.com/skx/gobasic) - Ein in Golang geschriebener BASIC-Interpreter
- [golisp](https://github.com/mattn/golisp) - `Lisp`-Interpreter
- [dst](https://github.com/dave/dst) - Go Decorated Syntax Tree
- [mvdan/sh](https://github.com/mvdan/sh) - Shell-Parsing, -Formatierung, -Schnittstelle
- [tdewolff/parse](https://github.com/tdewolff/parse) - lexikalischer Allzweckanalysator Lexer mit integrierter Unterstützung für das Parsen von HTML/CSS/JSON/XML/JS/SVG-Syntax
- [Joker](https://github.com/candid82/joker) - Clojure


####PHP
- [z7zmey/php-parser](https://github.com/z7zmey/php-parser) - PHP-AST-Syntaxanalyse
- [deuill/go-php](https://github.com/deuill/go-php) - PHP-Bindungen für Go
- [goridge](https://github.com/spiral/goridge) - Hochleistungs-PHP-zu-Golang-IPC-Brücke
- [RoadRunner](https://github.com/spiral/roadrunner) - Hochleistungs-PHP-Anwendungsserver, unterstützt Lastausgleich und Prozessmanagement
- [VKCOM/php-parse](https://github.com/VKCOM/php-parser) - PHP-AST-Syntaxanalyse


#### Benutzerdefinierter Dolmetscher
- [CUE](https://github.com/cuelang/cue) - Unify Execute konfigurieren (textbasierte und dynamische Konfiguration validieren und definieren)
- [cel-go](https://github.com/google/cel-go) - Common Expression Language (Go-Implementierung von CEL)
- [Math-Engine](https://github.com/dengsgo/math-engine) - In Go implementierte mathematische Ausdrucksanalyse und Berechnungs-Engine-Bibliothek, sehr gut geeignet zum Erlernen der Syntaxanalyse
- [Gval](https://github.com/PaesslerAG/gval) - Ausdrucksberechnung
- [Ausdrucksanalyse](https://github.com/vighneshq/expression-parsing)
- [goexp](https://github.com/svstanev/goexp) - Rekursiver Abstiegsausdrucksparser in Go
- [goastch](https://github.com/helloyi/goastch) - Gehen Sie zur AST-Syntaxanalyse
- [tdop](https://github.com/cristiandima/tdop)
- [schlucken](https://github.com/hwch/swallow)
- [Anko](https://github.com/mattn/anko)
- [Expr](https://github.com/antonmedv/expr) - Ausdrücke in Strings kompilieren und ausführen
- [Tengo](https://github.com/d5/tengo) - in Go geschriebene Skriptsprache
- [V](https://github.com/vlang/v) - in Go geschriebene Sprache
- [kumarUjjawal/bison](https://github.com/kumarUjjawal/bison)
- [Affe](https://github.com/skx/monkey)
- [govaluate](https://github.com/Knetic/govaluate)
- [Compiler] (https://github.com/MauriceGit/compiler) - Kompiliert benutzerdefinierten Syntaxcode in X86-64-Assembly
- [elvish](https://github.com/elves/elvish) - Interaktive Shell-Sprache
- [QLBridge](https://github.com/araddon/qlbridge) - Gehen Sie zur SQL-Laufzeit-Engine
- [YQL](https://github.com/caibirdme/yql) - Regelmodul im SQL-WHERE-Stil
- [Flux](https://github.com/influxdata/flux) - InfluxDB-Datensprache
- [Spiker](https://github.com/shockerli/spiker) - Ein einfacher, in Go geschriebener Executor für reguläre Ausdrücke, der benutzerdefinierte Funktionen und Prozesssteuerung unterstützt und für Szenarien mit komplexen Geschäftsregeln geeignet ist


### Codegenerierung
- [jennifer](https://github.com/dave/jennifer) - Go-Code-Generierung
- [ifacemaker](https://github.com/vburenin/ifacemaker) - generiert eine Schnittstelle basierend auf der Strukturmethode
- [gg](https://github.com/Xuanwo/gg) - Go-Code-Generierung


### Editor
- [micro](https://github.com/zyedidia/micro) - terminalbasierter Editor
- [sourcegraph](https://github.com/sourcegraph/sourcegraph) - Codesuche und -navigation


### Läufer
- [gore](https://github.com/motemen/gore) - Go-Code online ausführen
- [nodebook](https://github.com/netgusto/nodebook) - Führen Sie mehrere Sprachen online aus
- [go-pry](https://github.com/d4l3k/go-pry) - Geben Sie wie Python, R, PHP usw. interaktiv Go-Code im Terminal ein und führen Sie ihn aus


### Abfragesprache
- [graphql](https://github.com/graphql-go/graphql) - GraphQL-Implementierung in Go
- [graphql-go](https://github.com/graph-gophers/graphql-go)
- [GQLEngine](https://github.com/gqlengine/gqlengine) - basierend auf der graphql-go-Implementierung
- [RQL](https://github.com/a8m/rql) - REST-Ressourcenabfragesprache
- [Thunder](https://github.com/samsarahq/thunder) - GraphQL-Service-Building-Framework
- [gqlgen](https://github.com/99designs/gqlgen) - Paket zum Erstellen von GraphQL-Servern
- [super-graph](https://github.com/dosco/super-graph) - Erstellen Sie komplexe GraphQL-APIs in Go-Projekten, ohne Code schreiben zu müssen


### Spielbezogen
- [Nano](https://github.com/lonng/nano) - Spielentwicklungs-Framework
- [Blatt](https://github.com/name5566/blatt)
...
- [Ebiten](https://github.com/hajimehoshi/ebiten) - 2D-Spielbibliothek


### Desktop-Entwicklung
#### GUI
- [Lorca](https://github.com/zserge/lorca) - In Go geschriebene HTML5-Desktop-Anwendung, die für das Rendering der Benutzeroberfläche auf Chrome angewiesen ist, aber Chrome nicht in die Anwendung packt
- [webview](https://github.com/zserge/webview) - Plattformübergreifende Desktop-Software, die mit Go/C/C++ erstellt wurde
- [walk](https://github.com/lxn/walk) - Windows-GUI-Toolkit
- [go-gtk](https://github.com/mattn/go-gtk) - Go-Bindungen für GTK
- [andlabs/ui](https://github.com/andlabs/ui) - Plattformeigene GUI-Bibliothek für Go
- [fyne](https://github.com/fyne-io/fyne) - GUI im Materialdesign-Stil
- [go-gl](https://github.com/go-gl/gl) - Go-Bindungen für OpenGL (generiert über glow)
- [therecipe/qt](https://github.com/therecipe/qt) - Qt-basiertes plattformübergreifendes UI-Paket
- [giu](https://github.com/AllenDang/giu) - Plattformübergreifendes GUI-Framework basierend auf [Dear ImGui](https://github.com/ocornut/imgui)
- [go-app](https://github.com/maxence-charriere/go-app) - Ein WebAssembly-Framework zum Erstellen von GUI-Apps mit Go, HTML und CSS
- [wails](https://github.com/wailsapp/wails) - Erstellen Sie Desktop-Anwendungen mit Go- und Web-Technologien
- [chromedp](https://github.com/chromedp/chromedp) - browsergesteuertes Chrome DevTools-Protokoll, das in reiner Go-Sprache implementiert ist und in Crawler-, Anti-Crawler-, Test- und anderen Szenarien verwendet werden kann
- [Rod](https://github.com/go-rod/rod) - Ein devtools-Treiber, der zur Vereinfachung der Automatisierung und des Crawlings entwickelt wurde und die programmatische devtools-Schnittstelle des Browsers zur Steuerung des Browsers verwendet
- [go-astilectron](https://github.com/asticode/go-astilectron) - Plattformübergreifende Entwicklung basierend auf Electron
- [Gio](https://github.com/gioui/gio) - Plattformübergreifendes UI-Framework für mobile Anwendungen
- [nucular](https://github.com/aarzilli/nucular) - Gio-basierte Implementierung
- [GoVCL](https://github.com/ying32/govcl) - plattformübergreifendes GUI-Paket
- [vugu](https://github.com/vugu/vugu) - WebAssembly-UI-Framework
- [GoGi](https://github.com/goki/gi) - 2D/3D-GUI-Framework
- [systray](https://github.com/getlantern/systray) - Plattformübergreifende Unterstützung für die Menüleistenverwaltung
- [go-flutter ](https://github.com/go-flutter-desktop/go-flutter) - Binden Sie Flutter an Desktop-Anwendungen
- [NuxUI](https://github.com/nuxui/nuxui)


#### Desktop-Hilfspaket
- [pkg/browser](https://github.com/pkg/browser) - Öffnen Sie Dateien, URLs im Browser
- [MacDriver](https://github.com/progrium/macdriver) - native macOS-API
- [gon](https://github.com/mitchellh/gon) - Unterzeichnung und Beglaubigung für macOS

#### Desktopanwendung
- [xbar](https://github.com/matryer/xbar) - macOS-Menüleistenverwaltung basierend auf [Wails.app](https://github.com/wailsapp/wails)
- [Aliyunpan Little White Sheep Version] (https://github.com/liupan1890/aliyunpan) - UI wird von Flutter erstellt


### Handy, Mobiltelefon
- [golang/mobile](https://github.com/golang/mobile) - Go-Unterstützung für Mobilgeräte


### Coroutine/Thread
- [Ameisen](https://github.com/panjf2000/ants) - Goroutinen-Pool
- [tunny](https://github.com/Jeffail/tunny)
- [go-workers](https://github.com/catmullet/go-workers) - Führen Sie sicher eine Gruppe von Arbeitern gleichzeitig, Ein- und Ausgabe über Kanäle
- [Machine](https://github.com/autom8ter/machine) - Coroutinenverwaltung inspiriert von errgroup.Group
- [Thread](https://github.com/golang-design/thread)


### Aufgabe/Timer
- [RxGo](https://github.com/ReactiveX/RxGo) - Go-Version [ReactiveX](https://github.com/ReactiveX), einfache und bequeme Verarbeitung von asynchronen Datenströmen
- [Grift](https://github.com/markbates/grift) - Go-basierter Task-Runner
- [cron](https://github.com/robfig/cron) - eine Cron-Bibliothek für unterwegs
- [goCron](https://github.com/jasonlvhit/gocron) - Ein Jobplanungspaket von Golang
- [jobrunner](https://github.com/bamzi/jobrunner)
- [CurlyQ](https://github.com/mcmathja/curlyq) - Bibliothek zur Verarbeitung von Hintergrundaufgaben
- [overtalk/task](https://github.com/overtalk/task) - Aufgabenverwaltung und -ausführung, unterstützt benutzerdefinierte Anzahl von Wiederholungen
- [PPGo_Job](https://github.com/george518/PPGo_Job) - Zeitmanagementsystem für Aufgaben
- [gocelery](https://github.com/gocelery/gocelery) - Go-Sprachimplementierung von Celery
- [Maschinen] (https://github.com/RichardKnop/machinery) - Asynchrone Aufgabenplanung durch verteilte Nachrichten
- [dkron](https://github.com/distribworks/dkron) - Verteiltes Aufgabenplanungssystem
- [Grit](https://github.com/climech/grit) - Aufgabenverwaltung basierend auf der MultiTree-Implementierung
- [Asynq](https://github.com/hibiken/asynq) - Asynchrone verteilte Aufgabenwarteschlange
- [cronsun](https://github.com/shunfei/cronsun) - verteiltes Aufgabensystem


### Stream-Verarbeitung
- [Benthos](https://github.com/Jeffail/benthos)
- [gostream](https://github.com/itsubaki/gostream)
- [Wassermühle](https://github.com/ThreeDotsLabs/watermill)
- [go-streams](https://github.com/reugn/go-streams)
- [goflow](https://github.com/s8sg/goflow)
- [Cadence](https://github.com/uber/cadence) ([Cadence Web UI](https://github.com/uber/cadence-web)) - Ubers verteilte Open-Source-Workflow-Engine, hauptsächlich verwendet in Szenarien wie Microservice-Orchestrierung und verteilte Transaktionen


###WeChat
- [weapp](https://github.com/medivhzhan/weapp) - WeChat-Miniprogramm-SDK
- [wechat](https://github.com/silenceper/wechat) - WeChat-SDK für Go
- [wechat-go](https://github.com/songtianyi/wechat-go) - Go-Implementierung der WeChat-Web-API


###SDK
- [gopay](https://github.com/iGoogle-ink/gopay) - Go-Version SDK für QQ, WeChat, AliPay
- [alipay](https://github.com/smartwalle/alipay) - Alipay-SDK


### Blockchain
- [Hyperledger Fabric](https://github.com/hyperledger/fabric) - Hyperledger basierend auf Blockchain
- [go-ethereum](https://github.com/ethereum/go-ethereum) - Offizielle Go-Implementierung des Ethereum-Protokolls
- [bbgo](https://github.com/c9s/bbgo) - Framework für den Handel mit Kryptowährungen, geschrieben in Go
- [btcd](https://github.com/btcsuite/btcd) - Bitcoin-Implementierung


### Entwicklungshilfspaket
- [cvt](https://github.com/shockerli/cvt) - Beliebige Datentypkonvertierung, Unterstützung für benutzerdefinierte Typen, Extrahieren von Strukturfeldern und -werten
- [copier](https://github.com/jinzhu/copier) - Werte zwischen Strukturen kopieren
- [cast](https://github.com/spf13/cast) - Datentypkonvertierung
- [diff](https://github.com/r3labs/diff) - Struktur- und Wertevergleich
- [go-extend](https://github.com/thinkeridea/go-extend)
- [com](https://github.com/Unknwon/com) - Toolkit
- [php2go](https://github.com/syyongx/php2go) - Mehr als 140 in Go implementierte PHP-Funktionspakete
- [gommon](https://github.com/labstack/gommon) - Gängige Pakete für Go
- [**reflect2**](https://github.com/modern-go/reflect2) - Reflect API ohne Laufzeit-Reflect.Value-Kosten
- [mapstructure](https://github.com/mitchellh/mapstructure) - Kartenwert in Struktur umwandeln
- [naza](https://github.com/q191201771/naza) - Basisbibliothek für Go-Sprache
- [automaxprocs](https://github.com/uber-go/automaxprocs) - Automatisches Setzen von `GOMAXPROCS`
- [c2go](https://github.com/elliotchance/c2go) - Tool zum Konvertieren von C-Code in Go-Code
- [rnm](https://github.com/raviqqe/rnm) - Code-Refactoring-Hilfe
- [memviz](https://github.com/bradleyjkemp/memviz) - grafische Datenstruktur
- [underscore.go](https://github.com/ahl5esoft/golang-underscore)
- [go-testdeep](https://github.com/maxatome/go-testdeep) - Sehr flexibles Tiefenvergleichspaket, das das Go-Testpaket erweitert
- [go-model](https://github.com/jeevatkm/go-model) - `struct`-Operationspaket
- [concurrent-map](https://github.com/orcaman/concurrent-map) - Gleichzeitig sichere `Karte`
- [goleak](https://github.com/uber-go/goleak) - Erkennung von Goroutine-Lecks
- [guregu/null](https://github.com/guregu/null) - "null"-Verarbeitungspaket für SQL/JSON, das alternative Typen bereitstellt
- [stats](https://github.com/montanaflynn/stats) - Standardmäßige numerische Statistiken
- [Chronos](https://github.com/amit-davidson/Chronos) - statischer Renndetektor
- [Sammlung](https://github.com/jianfengye/collection) - Ersetzen Sie das native Slice
- [rf](https://github.com/rsc/rf) - Code-Refactoring-Tool
- [bytebufferpool](https://github.com/valyala/bytebufferpool) - Byte-Pufferpool
- [bpool](https://github.com/oxtoacart/bpool) - Bytepufferpool, unterstützt bytes.Buffers
- [mergo](https://github.com/imdario/mergo) - Struktur- und Wörterbuchdaten zusammenführen
- [go-funk](https://github.com/thoas/go-funk) - Allgemeine Funktionen, die basierend auf Reflektion implementiert werden
- [lo](https://github.com/samber/lo) - gemeinsame Funktionen basierend auf 1.18+ Generika
- [juniper](https://github.com/bradenaw/juniper) - Realisieren Sie gemeinsame Container-, Iterator-, Datenfluss- und andere Funktionen basierend auf Generika
- [mergo](https://github.com/imdario/mergo) - führt Strukturen und Wörterbücher zusammen
- [xstrings](https://github.com/huandu/xstrings) - Zeichenfolgenbezogene Funktionen


### Codegenerierung
- [ChimeraCoder/gojson](https://github.com/ChimeraCoder/gojson) - Struktur aus JSON generieren
- [db2struct](https://github.com/Shelnutt2/db2struct) - Struktur gemäß Tabellenstruktur generieren
- [smallnest/gen](https://github.com/smallnest/gen) - Struktur nach Tabellenstruktur generieren
- [**sqlc**](https://github.com/kyleconroy/sqlc) - Go-Code basierend auf SQL-Anweisungen generieren
- [xo](https://github.com/xo/xo) - Automatisches Generieren von Go-Code gemäß Tabellenstruktur oder Abfrageanweisung


### Systementwicklung
- [LinuxKit](https://github.com/linuxkit/linuxkit) - Toolkit zum Erstellen sicherer, portabler und portabler Betriebssysteme für Container
- [go-systemd](https://github.com/coreos/go-systemd) - systemd binden
- [Lima](https://github.com/AkihiroSuda/lima) - Linux-on-Mac ("macOS-Subsystem für Linux", "containerd für Mac")
- [gopher-os](https://github.com/gopher-os/gopher-os) - Ein Linux-kompatibles 64-Bit-System im POSIX-Stil
- [gouring](https://github.com/ii64/gouring) - Systemaufrufe implementieren, ohne sich auf CGO zu verlassen


### Nicht kategorisiert
- [go-playground](https://github.com/x1unix/go-playground) - Go Playground besser als der offizielle
- [Robotgo](https://github.com/go-vgo/robotgo) - Plattformübergreifendes Golang-Automatisierungssystem, steuert Tastatur- und Maus-Bitmap und liest Bildschirm, Fensterhandle und globale Ereignisüberwachung
- [go-homedir](https://github.com/mitchellh/go-homedir)
- [i18n](https://github.com/Unknwon/i18n) - `i18n` mehrsprachiges Toolkit
- [go-i18n](https://github.com/nicksnyder/go-i18n) - mehrsprachiges Toolkit
- [Paginator](https://github.com/Unknwon/paginator) - Paginierungstool
- [gls](https://github.com/jtolds/gls) - Lokaler Goroutine-Speicher
- [mcuadros/go-version](https://github.com/mcuadros/go-version) - Versionsnummernvergleich
- [go-semver](https://github.com/coreos/go-semver) - Semantische Versionierung
- [semver](https://github.com/Masterminds/semver) - Eine andere semantische Version
- [hashicorp/go-version](https://github.com/hashicorp/go-version)
- [Metabolize](https://github.com/keighl/metabolize) - Decodiert HTML-Meta-Tags in eine Golang-Struktur
- [otp](https://github.com/pquerna/otp) - Dienstprogramme für Einmalpasswörter
- [falsch geschrieben] (https://github.com/client9/misspell) - Häufig falsch geschriebene englische Wörter
- [CRDT](https://github.com/neurodrone/crdt) - Implementierung des endgültigen Konsistenzalgorithmus CRDT (Convergent and Commutative Replicated Data Types).
- [script](https://github.com/bitfield/script) - Erleichtert das Schreiben von Shell-ähnlichen Skripten in Go
- [sysadmin-utils](https://github.com/skx/sysadmin-utils)
- [licenseclassifier](https://github.com/google/licenseclassifier) – identifiziert den LIZENZ-Typ in der Datei
- [go-license-detector](https://github.com/go-enry/go-license-detector)
- [rose](https://gitlab.com/DevelopmentDuck/rose) - Go-Code in HTML einbetten und ausführen
- [esbuild](https://github.com/evanw/esbuild) - JavaScript-Build-Packaging-Tool
- [clipboard](https://github.com/d-tsuji/clipboard) - Plattformübergreifende Implementierung der Zwischenablage
- [Timeliner](https://github.com/mholt/timeliner) - Sammeln und organisieren Sie personenbezogene Daten auf Websites sozialer Netzwerke und indizieren Sie sie in Zeitleisten
- [hc](https://github.com/brutella/hc) - `HomeKit`-Plattformentwicklungs-Framework
- [Adresse](https://github.com/bojanz/adresse) - Adressverarbeitungsbibliothek, unterstützt mehrere Sprachen
- [webhook](https://github.com/adnanh/webhook) - Web-Hook-Dienst, der Shell-Befehle ausführen kann
- [webhookd](https://github.com/ncarlier/webhookd) - Web-Hook-Dienst für Shell-Skripte
- [go-cid](https://github.com/ipfs/go-cid) - [CID spec](https://github.com/ipld/cid) Go-Sprachimplementierung
- [gorush](https://github.com/appleboy/gorush) - APP-Nachrichtenbenachrichtigungsdienst
- [EventBus](https://github.com/asaskevich/EventBus) - Ereignisbus
- [go-winio](https://github.com/microsoft/go-winio) - bietet Schnittstellenunterstützung für Win32-IO-Operationen
- [Zwischenablage](https://github.com/atotto/clipboard) - Zwischenablage
- [fq](https://github.com/wader/fq) - liest binäre Daten/Dateien in [jq](https://github.com/stedolan/jq) Syntax
...
## Werkzeug
- [syndbg/goenv](https://github.com/syndbg/goenv) - Go-Versionsverwaltung
- [wfarr/goenv](https://github.com/wfarr/goenv) - Go-Versionsverwaltung
- [gvm](https://github.com/moovweb/gvm) - Go-Versionsverwaltung
- [GoLand](https://www.jetbrains.com/go/) - IDE-Software
- [Visual Studio-Code](https://github.com/microsoft/vscode)


## Ressourcenseite
- [Gehe 101](https://go101.org)
- [Go Language Chinese Network](http://studygolang.com)
- [Golang China](https://www.golangtc.com)
- [go-zh](https://go-zh.org)
- [Golang sizeof tips](https://github.com/tyranron/golang-sizeof.tips) - Geben Sie die Strukturdefinition ein und das Speicherlayout wird angezeigt
- [Golang-Programme](https://www.golangprograms.com)
